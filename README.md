<h1 align="center">Bootstrap Modern Unix</h1>


<p align="center">
  Bootstraps and configures the environment for modern cli development.
  It aims to be a curated list of utilities that aim for Safety, Speed, and Ease of Use.
</p>
...
<p align="center">
  <h1 align="center">
    <a href="https://wezfurlong.org/wezterm/"><code>Wezterm</code></a>
  </h1>
  <p align="center">WezTerm is a GPU-accelerated cross-platform terminal emulator and multiplexer 
    written by @wez and implemented in Rust
  </p>
  <p align="center">
    <img src="https://wezfurlong.org/wezterm/screenshots/two.png" width="600" />
  </p>
</p>

<p align="center">
  <h1 align="center">
    <a href="https://zsh.sourceforge.io/"><code>zsh</code></a>
  </h1>
  <p align="center">
    zsh is a shell designed for interactive use, although it is also a powerful scripting 
    language.
    I shopped around for some more modern shells but they have a smaller ecosystem but show
    promise. Will be keeping an eye out for a replacement.
  </p>
  <p align="center">
    <img src="https://zsh.sourceforge.io/Images/wizard.gif" width="600" />
  </p>
</p>

<p align="center">
  <h1 align="center">
    <a href="https://ohmyz.sh/"><code>oh my zsh</code></a>
  </h1>
  <p align="center">
  ...
  <p align="center">
    <img src="https://ohmyz.sh/img/themes/mh.jpg" width="600" />
  </p>
</p>

<p align="center">
  <h1 align="center">
    <a href="https://starship.rs/"><code>starship</code></a>
  </h1>
  <p align="center">
...
<p align="center">
  ...
  <p align="center">
    <code>dot</code>provides a way to organize configuration files in your home directory.
  </p>
</p>

<p align="center">
  <h1 align="center">
    <a href="https://github.com/uutils/coreutils"><code>uutils coreutils</code></a>
  </h1>
  <p align="center">
    uutils aims to work on as many platforms as possible, to be able to use the same utils on 
    Linux, Mac, Windows and other platforms. This ensures, for example, that scripts can be easily
    transferred between platforms. Rust was chosen not only because it is fast and safe, but is 
    also excellent for writing cross-platform code.
  </p>
</p>
